...
/**
 * This is just a trimmed down version of https://github.com/ZeeCoder/use-resize-observer/blob/master/src/index.ts
 */
...
function useResolvedElement<T extends HTMLElement>(
  ...
  // it'll be used as that's how hooks work (no conditional hooks)
